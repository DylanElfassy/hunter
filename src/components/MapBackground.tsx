...
const MapBackground = () => {
  ...
  useEffect(() => {
    ...
    // #region treasure coordinates & model configs

const allTreasureCoords: [number, number][] = [
  [-73.969, 40.7644],
  [-73.9677, 40.7723],
  [-73.9774, 40.7794],
  [-73.9752, 40.7580],
...
// Only a few treasures for mobile
const mobileTreasureCoords: [number, number][] = [
  [-73.969, 40.7644],
  [-73.9677, 40.7723],
  [-73.9862, 40.7656],
  // [-73.9818, 40.7740],
